...
create table stories(id integer primary key, name text, year integer, name_de text, inducks_id text);
...
create table movements(id integer primary key, movers text, origin_place text, origin_time text, destination_place text, destination_time text, movement_mode text, purpose text, comment text, story_id integer, trip_id integer, foreign key(story_id) references stories(id));
